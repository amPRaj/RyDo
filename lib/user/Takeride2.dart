...
class Takeride2 extends StatefulWidget {
  ...
  const Takeride2({super.key, required this.start,required this.end,required this.person,required this.date2,required this.login_id,});
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          String startingPlace = car['starting_place'] ?? '';
          String endingPlace = car['ending_place'] ?? '';
          String startingTime = car['starting_time'] ?? '';
          String person = car['person'] ?? '';
          String startingPlacedis = car['starting_placedis'] ?? '';
          String endingPlacedis = car['ending_placedis'] ?? '';
