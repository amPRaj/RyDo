          ...
          Container(
            ...
            child: Row( // Use Row to display date and starting_time side by side
              children: [
                ...
                const SizedBox(width: 16), // Add some space between the date and starting_time
                Column(
                  children: [
                    Text(
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    String firstName1 = car['first_name'] ?? '';
                    String profilepic1 = car['profilepic'] ?? '';
                    String lastName1 = car['profilepic'] ?? '';
                    String phoneNo1 = car['Phone_no'] ?? '';
