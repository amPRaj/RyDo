            ...
            child: ListView(
              children: [
                RadioListTile(
                  ...
                  title: const Text("I love pets. Woof!"),
                ...
                RadioListTile(
                  ...
                  title: const Text("I’ll travel with pets depending on the animal"),
                  secondary: const Icon(Icons.pets,color: Colors.green),
                  activeColor: Colors.blue,
                ),
                RadioListTile(
                  ...
                  title: const Text("Sorry, not a pet person"),
                  secondary: const Icon(Icons.do_not_disturb,color: Colors.green),
                  activeColor: Colors.blue,
                ),
              ],
            ),
