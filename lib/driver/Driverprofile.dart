                      ...
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: AssetImage(
                            "server/public/images/$profilepic", // Replace with your profile picture
                          ),
                        ),
                                  ...
                                  showDialog(
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        ...
                                        content: const Text('Passwords do not match. Please re-enter and try again.'),
                                        actions: [
                                          TextButton(
                                            onPressed: () {
          ...
          Expanded(
            child: Wrap(
              children: [
                Text(
                  value,
                  style: const TextStyle(fontSize: 16), // You can adjust the font size as needed
                ),
              ],
            ),
          ),
